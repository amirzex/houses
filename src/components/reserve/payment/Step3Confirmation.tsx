            ...
            <div className="flex flex-col justify-center gap-6 lg:flex-row lg:gap-8">
                ...
                <div className="flex w-full flex-col gap-6 lg:w-[70%]" dir="rtl">
                    ...
                    <div className="flex flex-col gap-4 text-gray-700">
                        ...
                        <div className="flex flex-wrap items-center gap-6 text-gray-600 dark:text-[#D9D9E0]">
                            <div>شماره تماس <span className="font-semibold text-brand text-lg mr-2 dark:text-blue-600/90">09229167194</span></div>
                            <div>ایمیل <span className="font-semibold text-brand text-lg mr-2 dark:text-blue-600/90">Example@gmail.com</span></div>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full lg:w-[30%]" dir="rtl">
                    <div className="bg-gray-100 dark:bg-[#353535]  rounded-2xl p-6 flex flex-col gap-4">
                        ...
                        <button className="w-full bg-brand text-white py-3 rounded-full mt-4 hover:bg-brand-hover transition">
                            ویرایش مسافران
                        </button>
                    </div>
                </div>
