        ...
        <div className='flex flex-col w-full px-15 max-sm:px-5 gap-16 font-sans text-gray-800' dir="rtl">
            ...
            <div className='w-full flex flex-col md:flex-row justify-between items-center gap-10'>
                ...
                <div className='w-full md:w-[40%] flex flex-col  gap-4 items-start'>
                    ...
                    <div className="flex flex-row-reverse items-center justify-center w-[80%] max-sm:w-full bg-white dark:bg-[#353535] p-4 rounded-3xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07)] border-r-4 border-brand">
                    ...
                    <div className="flex flex-row-reverse items-center justify-center w-[80%] max-sm:w-full dark:bg-[#353535] bg-white p-4 rounded-3xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07)] border-r-4 border-brand">
            ...
            <div className="w-full flex flex-col gap-8">
                <div className="text-center flex flex-col gap-2">
                    <span className="text-brand font-bold text-sm">برای بهترین تجربه</span>
